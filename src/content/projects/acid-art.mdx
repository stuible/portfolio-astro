...
subtitle: How I developed a fast e-commerce website for a boutique clothing brand
tags:
  - nuxt
  - vue
  - sass
...
The original website's shopping & checkout flow was slow & difficult to navigate for users. The inconsistent design elements made it hard to use, especially on mobile. All this was for a monthly operational cost that was hurting John's bottom line.
...
<Picture
  src={import("../../assets/images/projects/product-page.jpg")}
  widths={[
    5000, 800,
...
With customers flocking to ACiD's modern and flexible e-commerce experience, John can focus on his work, expand ACiD's inventory, and continue growing his business.
