...
Each catchment area was presented to us as a list of complicated rules. This list was very much designed for a human to triage patients over the phone rather than something that could be used programatically by an algorithm. To solve this, I converted the catchment area rules to a set of coordinate polygons would represent the boundries of each cathment area. With this set of polygons, I then transform the user's adress to a coordinates using the Mapbox Geocoding API and determine which catchment area it falls into using [this package](https://www.npmjs.com/package/point-in-polygon-hao) which does a great job of implementng this [point-in-polygon algorithm](https://www.researchgate.net/publication/328261365_Optimal_Reliable_Point-in-Polygon_Test_and_Differential_Coding_Boolean_Operations_on_Polygons).
